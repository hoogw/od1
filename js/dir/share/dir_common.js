...
function build_url_base_template(){
  ...
  url_template_esri = window.location.origin + "/open-data/map/esri/click.html"
  ...
  url_template_google = window.location.origin + "/open-data/map/google/click.html"
  url_template_google_mapimagelayer = window.location.origin + "/open-data/map/google/mapimagelayer.html"
  url_template_apple = window.location.origin + "/open-data/map/apple/click.html"
...
var esri_system_managed_field_array = [
                      ...
                      // more
                      'length', 'area', 'shape_length','shape_area',  
